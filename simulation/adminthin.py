...
# Variables to alter.
numRun = list(range(361,461,1)) #Number of runs to execute for each variable set. Enumerate these!!! 
...
l = [1] #Ligament thicknesses. MULTIPLY by ao to get thickness in Angstroms. Go down to 20 ao in the end!  
...
HeLatParMultip = 2 #Factor used to make the HeLatpar larger than LatPar. 
...
runTime = {'short':'8:00:00','med':'36:00:00','long':'48:00:00'} #Lewis run lengths for small, medium, and large bubbles.
